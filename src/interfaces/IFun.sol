...
import {IExecution, NodeState, Movement} from "./IExecution.sol";
...
interface IFun is IERC1155, IExecution {
    ...
    function getUserNodeSignals(address user, uint256 targetNode) external view returns (uint256[] memory);
